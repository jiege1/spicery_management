...
require([
    ...
    //
    // sort page1Api within a group by title ASC and custom order
    //
    var newList = [];
    ...
    // page1Api overwrite with ordered list
    api = newList;
    ...
    $('#versions li.version a').on('click', function(e) {
        ...
        $('article[data-version]').each(function(index) {
            var group = $(this).data('group');
            $('section#page1Api-' + group).removeClass('hide');
            if ($('section#page1Api-' + group + ' article:visible').length === 0) {
                $('section#page1Api-' + group).addClass('hide');
            } else {
                $('section#page1Api-' + group).removeClass('hide');
            }
        });
